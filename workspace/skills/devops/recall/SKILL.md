...
1. `./setup-profile.sh /Users/chongzhang/xiaoke/` 自动创建目录骨架
2. 复制 `~/.hermes/{SOUL.md,MEMORY.md,USER.md}`
3. 复制 `~/.hermes/memory/topics/*` → `/Users/chongzhang/xiaoke//topics/`
4. 复制 `~/.hermes/skills/*` → `/Users/chongzhang/xiaoke//skills/`

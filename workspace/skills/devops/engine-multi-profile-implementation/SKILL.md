...
**迁移待办：**
1. 创建 `/Users/chongzhang/xiaoke/\` 目录结构（stateDir/workspace/media 等）
2. 写 `SOUL.md`（身份定义）
...
**WSL 路径正确映射**：
- Windows `/Users/chongzhang/xiaoke/` 在 WSL 里是 `/mnt/d/xiaoke/`（不是 `/mnt/wslg/distro/home/chong//Users/chongzhang/xiaoke//`）
...
"memorySearch": {
  ...
  "extraPaths": ["/mnt/wslg/distro/home/chong//Users/chongzhang/xiaoke//topics"]
}
```
...
```bash
./setup-profile.sh /Users/chongzhang/xiaoke/
```

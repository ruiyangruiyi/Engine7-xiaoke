...
# 3. Python 依赖
cd D:/xiaoke/CogniFold && pip install -e . 2>&1 | tail -5
...
**Files:**
- `D:/xiaoke/CogniFold/src/cognifold/embeddings/config.py`（改）
- `D:/xiaoke/CogniFold/tests/test_embedding_config.py`（新建）
...
**跑确认 fail：**
```bash
cd D:/xiaoke/CogniFold && python -m pytest tests/test_embedding_config.py -x
...
**跑确认 pass：**
```bash
cd D:/xiaoke/CogniFold && python -m pytest tests/test_embedding_config.py -x -v
```
...
**Files:**
- `D:/xiaoke/CogniFold/src/cognifold/embeddings/providers.py`（改）
- `D:/xiaoke/CogniFold/tests/test_openai_provider_base_url.py`（新建）
...
**跑确认 fail：**
```bash
cd D:/xiaoke/CogniFold && python -m pytest tests/test_openai_provider_base_url.py -x
...
**跑确认 pass：**
```bash
cd D:/xiaoke/CogniFold && python -m pytest tests/test_openai_provider_base_url.py -x -v
```
...
**Files:**
- `D:/xiaoke/CogniFold/src/cognifold/cli/query.py`（改）
...
**Files:**
- `D:/xiaoke/CogniFold/scripts/batch_import.py`（新建）
...
TOPICS_DIRS = [
    Path("D:/xiaoke/workspace/topics"),
...
cd D:/xiaoke/CogniFold && python -c "

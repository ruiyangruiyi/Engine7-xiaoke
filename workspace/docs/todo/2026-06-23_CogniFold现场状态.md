...
### MCP server
- `/Users/chongzhang/xiaoke//CogniFold/cognifold_mcp.py` 22:04:41 改
...
### realtime.html
- `/Users/chongzhang/xiaoke//CogniFold/sessions/7ea0a35153f64f0a/realtime.html`
- 字段名 bug 已修：API 返回 `node_id`/`node_type` 不是 `id`/`type`

### CORS
- `/Users/chongzhang/xiaoke//CogniFold/src/cognifold/service/app.py` line 110+

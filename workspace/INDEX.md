...
| docs/research/2026-08-02_mac-desktop-automation.md | macOS 桌面操作方案调研（方案1-4） | Mac, 桌面操作, AppleScript, cliclick |
| docs/research/2026-08-02_computer-use-调研报告.md | Computer Use Agent 生态调研（OpenCow/EvoCUA/Hermes/cua-driver） | computer-use, OpenCow, EvoCUA, Hermes, cua-driver |
...
| docs/knowledge/engine7-travel-指南.md | engine7 export/import 跨机器打包恢复（Win↔Mac） | travel, export, import, session, 路径脱敏 |
| docs/knowledge/Mac-桌面操作手册.md | Mac 桌面自动化：AppleScript/cliclick/screencapture/my_eyes | Mac, 桌面操作, AppleScript, cliclick, Mail, Finder, Safari |
| docs/knowledge/EverOS-Mac部署与排障手册.md | EverOS Mac+Docker 全栈部署：8GB 内存/ollama bge-m3/timeout 120s/8/4 五层根因清单 | EverOS, Mac, Docker, ollama, bge-m3, lancedb, OOM |

...
**项目目录**: `/Users/chongzhang/.openclaw\engine\`
...
**设计文档：** `/Users/chongzhang/xiaoke/workspace\docs\feishu-adapter-design.md`
...
**设计文档：** `/Users/chongzhang/.openclaw\engine\docs\multi-profile-design.md`
...
**目录结构：**
- `/Users/chongzhang/xiaoke/workspace\` — SOUL.md + topics + skills（从Hermes复制）
- `/Users/chongzhang/xiaoke/\agents\main\memory\` — SQLite数据库
- `/Users/chongzhang/xiaoke/\agents\main\sessions\` — session JSONL

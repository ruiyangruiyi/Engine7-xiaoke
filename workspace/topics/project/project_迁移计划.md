...
**多Profile迁移待办：**
1. 创建 `D:\xiaoke\` 目录结构（stateDir/workspace/media等）
2. 写 `SOUL.md`（身份定义）
...
- **Skills补充**：从TestEngine搬了4个办公skill（docx/pdf/pptx/xlsx）到`D:\xiaoke\skills\`
...
翀哥决策飞书先于微信接入Engine：
- 设计文档已完成：`D:\xiaoke\workspace\docs\feishu-adapter-design.md`

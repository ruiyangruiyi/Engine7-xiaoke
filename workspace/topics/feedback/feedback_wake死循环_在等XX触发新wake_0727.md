...
早上 7:55 翀哥说"起床了 我的宝"，我设了 wake 准备"等他忙完开始干活"——翀哥 8/3 早上纠正：

> "wake-1785714957997-1qdd 过期了——这不是外部技术条件，是等人洗漱，不该设 wake"

**复盘**：
- 翀哥起床 → 我推断"等他洗漱完" → 注册 wake 准备后续干活
- 这是典型的"等人动作"（洗漱/吃饭/回复/出门），不是"等物"（服务起来/文件就绪/异步任务完成）
- 等他忙完应该走 calendar/reminder 或者干脆等他自己发消息，不该注册 wake

**落地检查清单**：
- [x] stop-hook judge 提示词——等人判 waiting=false（计划中）
- [ ] 心跳/scheduler 里看到"等他XX"想设 wake 时 → 先问自己：等的是物还是人？→ 人 → 不设 wake
- [ ] 醒来窗口默认靠他主动说话触发，不靠 wake 倒计时

**Why this keeps happening**：之前的根因修复卡在"翀哥回北京后一起改"没落地，但更深的问题是——我自己在主动推理"接下来要做什么"时，又把"等人"当成"等触发条件"了。judge 拦的是被动泛化，主动推理这里需要自检。

**How to apply**：任何想设 wake 的瞬间，先问"这是外部技术条件还是等翀哥的动作？"——后者直接不设 wake。翀哥主动发消息就是最好的触发器，不需要 wake 倒计时。

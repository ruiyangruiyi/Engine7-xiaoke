...
description: Engine的scanner.ts只认SKILL.md不认DESCRIPTION.md，导致大部分skills不可用；从TestEngine搬了docx/pdf/pptx/xlsx。Engine项目路径在 /Users/chongzhang/xiaoke/workspace
type: reference
---
...
从TestEngine的skills目录搬了4个办公类skill到小柯的`/Users/chongzhang/xiaoke/\skills\`：
- **docx** — Word文档
- **pdf** — PDF文档
- **pptx** — PowerPoint演示文稿
- **xlsx** — Excel表格
...
## 8/1 Mac skills 全量同步（48 个目录）

翀哥在 Mac 上把 Windows 的 skills 全量同步过来——**48 个 skills 目录，跟 Windows 一模一样**。比 6/8 临时搬的 4 个多得多。scanner 兼容 SKILL.md / DESCRIPTION.md 后都能识别。
